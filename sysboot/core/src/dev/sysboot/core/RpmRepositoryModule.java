...
public record RpmRepositoryModule(
    ModuleName name,
    String repositoryId,
    URI baseUrl,
    Path repoFilePath,
  ...
  public RpmRepositorySourceSetup asSourceSetup() {
    return new RpmRepositorySourceSetup(
        name, repositoryId, baseUrl, repoFilePath, gpgKeyUrl, enabled, gpgCheck, artifactSha256);
  }
